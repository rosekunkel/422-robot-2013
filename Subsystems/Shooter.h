...
public:
	...
	float getFirstWheelOfset();
	
	float getSecondWheelOfset();
...
private:
	...
	static const float P_FIRST, I_FIRST, D_FIRST,
	                   P_SECOND, I_SECOND, D_SECOND;
	...
	static const float FIRST_MOTOR_MAX_RPS, SECOND_MOTOR_MAX_RPS;
