...
const UINT32 FIRST_SHOOTER_WHEEL_CHANNEL = 0,
...
const UINT32 FIRST_SHOOTER_ENCODER_CHANNEL_A = 0,
	         FIRST_SHOOTER_ENCODER_CHANNEL_B = 0,
             SECOND_SHOOTER_ENCODER_CHANNEL_A = 0,
	         SECOND_SHOOTER_ENCODER_CHANNEL_B = 0;
/**@}*/
